...
<head>
    ...
    <title>Admin Account Data</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $ambilsemuadatastock = mysqli_query($conn, "select * from login WHERE level='admin'");
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="update-akun-admin">Submit</button>
                                                            </div>
                                                        </form>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapus-akun-admin">Submit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    <input type="text" name="username" placeholder="Username Admin" class="form-control" required>
                    <br>
                    <input type="text" name="email" placeholder="Email Aktif" class="form-control" required>
                    <br>
                    <input type="text" name="password" placeholder="Password" class="form-control" required>
                    <br>
                    <button type="submit" class="btn btn-primary" name="tambah-akun-admin">Submit</button>
                </div>
            </form>
