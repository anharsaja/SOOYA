                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $status; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#kirim<?= $idp; ?>">
                                                        Kirim
                                                    </button>
                                                    
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#batal<?= $idp; ?>">
                                                        Batal Kirim
                                                    </button>
                                                </td>
